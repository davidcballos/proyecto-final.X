...
void usartInit(uint32_t BAUDRATE){
    TRISCbits.TRISC6 = 0;
    TRISCbits.TRISC7 = 1;
    if(48000000UL <= 4000000){

        SPBRG = (unsigned char)((48000000UL/(BAUDRATE*16.0))-1.0);
        TXSTA = 0x24;
    }
    else{
        SPBRG = (unsigned char)((48000000UL/(BAUDRATE*64.0))-1.0);
        TXSTA = 0x20;
    }
    RCSTA = 0x90;
}
...
_Bool usartKbit(void){
    if(RCIF){return 1; RCIF = 0;}
    else{ return 0; RCIF = 0;}
}
